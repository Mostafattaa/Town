      ...
      <div className=" p-10">
        <div className="flex flex-col coll:flex-row  gap-9 p-10">
          <div className="flex flex-col justify-center text-center items-center p-5">
            <h1 className="text-4xl text-white text-center">First Work</h1>
            <a
          ...
          <div className="flex flex-col justify-center  items-center p-5">
            <h1 className="text-4xl  text-white text-center">Second Work</h1>
            <a
              className="p-1 text-[19px] text-blue-500 font-medium cursor-pointer hover:text-blue-700"
              href="#"
            >
          ...
          <div className="flex flex-col justify-center items-center p-5">
            <h1 className="text-4xl text-white text-center">Third Work</h1>
            <a
              className="p-1 text-[19px] text-blue-500 font-medium cursor-pointer hover:text-blue-700"
              href="#"
            >
